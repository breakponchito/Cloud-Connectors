...
@MessageDriven(activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "ssoAccountId", propertyValue = "${ENV=ssoAccountId}"),
        @ActivationConfigProperty(propertyName = "ssoRoleName", propertyValue = "${ENV=ssoRoleName}"),
        @ActivationConfigProperty(propertyName = "ssoRegion", propertyValue = "${ENV=ssoRegion}"),
        @ActivationConfigProperty(propertyName = "ssoStartUrl", propertyValue = "${ENV=ssoStartUrl}")
})
